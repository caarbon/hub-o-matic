...
GitHub.prototype.comments = function(callback) {
  return this.handler('comments', callback);
};

GitHub.prototype.commits = function(ref, callback) {
  return this.handler('commits/' + ref, callback);
};

GitHub.prototype.issues = function(callback) {
  return this.handler('issues', callback);
};

GitHub.prototype.feeds = function(callback) {
  return this.handler('feeds', callback);
};

GitHub.prototype.notifications = function(callback) {
  return this.handler('notifications', callback);
};

GitHub.prototype.threads = function(id, callback) {
  return this.handler('threads/' + id, callback);
};

GitHub.prototype.subscription = function(callback) {
