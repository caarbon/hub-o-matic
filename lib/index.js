...
function GitHub(opts) {
  ...
  this.request = function(opts, callback) {
    ...
    require('request')(req, function(err, res, body) {
      ...
      var paging = {
        get first() {
          return paged('first', res, opts, callback);
        },

        get prev() {
          return paged('prev', res, opts, callback);
        },

        get next() {
          return paged('next', res, opts, callback);
        },

        get last() {
          return paged('last', res, opts, callback);
        }
      };
  ...
  function paged(direction, res, opts, callback) {
